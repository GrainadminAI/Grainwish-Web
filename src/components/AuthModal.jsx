      ...
      <div className="relative w-full max-w-md bg-gradient-to-b from-[#06331f] via-[#042114] to-[#02140c] border-2 border-emerald-500/50 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full p-3 rounded-xl bg-white text-slate-900 font-bold text-xs shadow-md flex items-center justify-center gap-2 hover:bg-slate-100 transition-colors"
          >
            <Chrome className="w-4 h-4 text-red-500" /> Continue with Google OAuth
          </button>
