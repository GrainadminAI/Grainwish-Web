            ...
            {currentUser ? (
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-1.5 bg-white hover:bg-slate-100 text-slate-900 border border-slate-200 rounded-xl text-xs font-bold transition-all shadow-md flex items-center gap-1.5"
                >
                ...
                <button
                  onClick={() => setAuthModalOpen(true)}
                  className="px-3.5 py-1.5 bg-emerald-950/80 hover:bg-emerald-900 border border-emerald-700/50 rounded-xl text-xs font-semibold text-emerald-300 hover:text-white transition-colors flex items-center gap-1.5"
                >
